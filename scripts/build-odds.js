...
const MARKET = 'h2h';   // moneyline only. Tennis set handicaps aren't reliably
                        // carried by The Odds API (spreads = games handicaps),
                        // so set odds are entered manually in the dashboard.
...
(async()=>{
  ...
  // Step 2: odds per comp, filtered to our books (moneyline only)
